...
from user.models import PartnerStore, Kiosk, Product
...
class Command(BaseCommand):
    help = 'Creates a new kiosk for a given store, sets up all necessary associations, loads products, and generates QR codes'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if kiosk:
                ...
                kiosk_qr_code_service.create_and_associate_qr_codes()
